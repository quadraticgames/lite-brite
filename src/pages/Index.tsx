    ...
    <div className="min-h-screen bg-gray-900 py-8 px-4 flex flex-col items-center">
      <div className="w-full max-w-4xl flex flex-col items-center mb-8">
        <img 
          ...
          alt="Lite-Brite Box" 
          className="max-w-md w-full mb-4 rounded-lg"
        />
        ...
        <div className="text-center text-yellow-200 mb-6 max-w-2xl">
          <p className="mb-1">• Click on pegs to add or remove colored lights</p>
          <p className="mb-1">• Hold and drag to paint multiple pegs at once</p>
          <p className="mb-1">• Use the text tool to create glowing text</p>
          <p className="mb-1">• Undo mistakes with the undo button</p>
        </div>
      </div>
      <LiteBriteBoard />
    </div>
